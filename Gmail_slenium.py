...
mail_id.send_keys("akkul.dn@qxf2.com") #Enter the id into the textbox
...
mail_pass.send_keys("testexam")#Enter the password
...
time.sleep(4)
driver.find_element_by_xpath("//textarea[@name='to']").send_keys("akkul.dn@qxf2.com")#Enter receptient mail adress into the To field
